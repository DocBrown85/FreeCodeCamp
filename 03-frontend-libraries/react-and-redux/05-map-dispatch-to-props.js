 ...
 * You have access to this dispatch because it's passed in to mapDispatchToProps()
 * as a parameter when you define the function, just like you passed state to mapStateToProps().
