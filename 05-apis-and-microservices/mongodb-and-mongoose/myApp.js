...
var findPeopleByName = function(personName, done) {
  var person = Person.find({name: personName}, function(err, data) {
...
var findOneByFood = function(food, done) {
  var person = Person.findOne({favoriteFoods: food}, function(err, data) {
    if (err) console.log(err);
    done(null, data);
  });
};
...
var findPersonById = function(personId, done) {
  var person = Person.findById(personId, function(err, data) {
    if (err) console.log(err);
    done(null, data);
  });
};
